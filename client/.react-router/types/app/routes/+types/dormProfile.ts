...
// routes/dormProfile.tsx

import type * as T from "react-router/route-module"

import type { Info as Parent0 } from "../../+types/root.js"

type Module = typeof import("../dormProfile.js")

export type Info = {
  parents: [Parent0],
  id: "routes/dormProfile"
  file: "routes/dormProfile.tsx"
  path: "/dorms/:dorm"
  params: {"dorm": string} & { [key: string]: string | undefined }
  module: Module
